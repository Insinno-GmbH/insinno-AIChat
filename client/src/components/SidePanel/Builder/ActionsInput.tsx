    ...
    <>
      ...
      <div className="flex items-center justify-end">
        <button
          ...
          onClick={saveAction}
          className="btn btn-primary focus:shadow-outline mt-1 flex min-w-[100px] items-center justify-center rounded px-4 py-2 font-semibold focus:outline-none focus:ring-0"
          type="button"
        >
          {submitContext()}
        </button>
